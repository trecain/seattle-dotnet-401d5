![cf](http://i.imgur.com/7v5ASc8.png) Class 01: Exception Handling and Debugging
=====================================
...
1. Kickoff
1. Introductions
1. Intro lab assignment

#### Afternoon
1. FrontRow Video System
2. Syllabus - Questions and Clarity?
...
### Error Handling while during Lab:
   - What do you do if you encounter an error (white board // draw it)
   - 15 min rule
